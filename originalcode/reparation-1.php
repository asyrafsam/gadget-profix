      ...
      <div class="table-responsive" style="width: 100%;">
        <table class="table table-striped table-bordered" id="dataTable" width="50%" cellspacing="0" style="font-size: 13px;color: #000;">
          ...
          <?php
            ...
            {
              $all = $r->creditTotal - $r->pay_amount;
              if ($test % 2 == 0){
                 $test1 ="even";
              }else{
                 $test1 = "odd";
          ...
          <tbody>
            ...
            <tr style="background-color: #fdfafa;">
              ...
              <td>
                <div class="dropdown no-arrow">
                  ...
                  <div class="dropdown-menu dropdown-menu-left shadow animated--fade-in" aria-labelledby="dropdownMenuLink">
                    <div class="dropdown-header">Export in:</div>
                    <a class="dropdown-item" href="#" onclick="view_reparation('<?php echo $r->r_code?>')"><i class="fa fa-fw fa-edit"> &nbsp;View</i></a>
                    <a class="dropdown-item" href="#"><i class="fa fa-fw fa-file-pdf"> &nbsp;&nbsp;Invoice</i></a>
                    <a class="dropdown-item" href="#"><i class="fa fa-fw fa-barcode"> &nbsp;View Attachments</i></a>
                    <a class="dropdown-item" href="#" onclick="view_reparationlog('<?php echo $r->r_repairno?>')"><i class="fa fa-fw fa-trash"> &nbsp;View Log</i></a>
                    <a class="dropdown-item" href="#" onclick="view_payment('<?php echo $r->r_code?>')"><i class="fa fa-fw fa-trash"> &nbsp;View Payments</i></a>
                    <a class="dropdown-item" href="#" onclick="add_payment('<?php echo $r->r_code?>')"><i class="fa fa-fw fa-trash"> &nbsp;Add Payment</i></a>
                    <a class="dropdown-item" href="#" onclick="editReparation('<?php echo $r->r_code?>')"><i class="fa fa-fw fa-trash"> &nbsp;Edit</i></a>
                    <a class="dropdown-item" href="#" onclick="deleteReparation('<?php echo $r->r_repairno?>')""><i class="fa fa-fw fa-trash"> &nbsp;Delete</i></a>
                    <!-- <a class="dropdown-item" href="#"><i class="fa fa-fw fa-trash"> &nbsp;Print Barcode</i></a> -->
                  </div>
                </div>
              </td>
            </tr>
            ...
            ?>
              ...
              <td><?php echo $r->r_model?></td>
              <td><?php echo $r->r_opened?></td>
              <td><button class="btn btn-danger" style="width: 80px;height: 30px;font-size: 12px;"><?php echo $r->r_status?></button></td>
              <td><?php echo $r->r_assigned?></td>
              <td><?php echo $r->r_created?></td>
              <td><?php echo $r->r_lastmodified?></td>
              <td><?php echo $r->r_file?></td>
