...
<div class="container-fluid">
  <h1 class="h3 mb-2 text-gray-800">Open Shift  </h1>
  <div class="col-lg-6" style="float: right;margin-top: -30px;left: 25%;font-size: 20px;">
    <?php echo date('d-m-Y H:i:s')?>
  </div>
  <hr>
  <form class="row" action="<?php echo base_url('func_pos/openDrawer'); ?>" method="post" id="form" enctype="multipart/form-data">
