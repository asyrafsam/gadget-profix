        ...
        <div class="card-body">
          ...
          <div class="form-group input-group">
            <div class="input-group-prepend">
              ...
              <input name="" class="form-control" placeholder="Email to" type="text">
          </div> 
          <div class="form-group input-group">
            <div class="input-group-prepend">
              <span class="input-group-text"> <i class="fas fa-fw fa-file-signature"></i> </span>
          </div>
              <input name="" class="form-control" placeholder="Subject" type="text">
          </div>
          <div class="form-group input-group">
            <div class="input-group-prepend">
              <span class="input-group-text"> <i class="fas fa-fw fa-pen"></i> </span>
            </div>
              <textarea name="" class="form-control" placeholder="Product Details" rows="4"></textarea>
          </div>
