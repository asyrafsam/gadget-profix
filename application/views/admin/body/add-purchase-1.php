...
<div class="container-fluid">
  <h1 class="h3 mb-2 text-gray-800">Add Purchase</h1>
  <hr>
  <div class="row">
    <form action="<?php echo base_url(). 'func_purchase/addpurchase'; ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="card-body col-lg-12">
          ...
          <div class="form-group input-group col-lg-4">
            <div class="input-group-prepend">
              ...
              <input type="text" name="refno" class="form-control" placeholder="Reference No">
          </div>
          <div class="form-group input-group col-lg-4">
            <div class="input-group-prepend">
  ...
                </select>  
          ...
          <div class="form-group input-group col-lg-12">
            ...
            <div class="div1 col-lg-12" id="fn">
              ...
              <div class="flex-more col-lg-12" >
                ...
                <div class="form-group input-group col-lg-4">
                  ...
                  <input class="form-control" id="discount" name="discount" onchange="disc();" placeholder="Discount" type="text">
                </div>
                <div class="form-group input-group col-lg-4">
                  <div class="input-group-prepend">
                    <span class="input-group-text"> <i class="fas fa-fw fa-dolly"></i> </span>
                  </div>
                  <input  class="form-control" name="ship" placeholder="Shipping" type="text">
                </div>
              </div>
            </div>
          </div>
            ...
            <input type="hidden" name="holdd" id="hold_value" value="<?= rand();?>">
