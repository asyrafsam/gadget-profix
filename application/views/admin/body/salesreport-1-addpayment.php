<div class="modal fade" id="addpaymentModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          ...
          <form action="<?php echo base_url('func_report/add_payment'); ?>" method="POST" enctype="multipart/form-data">
    ...
    <script type="text/javascript">
      ...
      function add_paymentsales(id){
        // save_method = 'update';
        // $('#formX')[0].reset();

        /*load data dari ajax sama macam concept atas*/
        $.ajax({
          url:"<?php echo site_url('func_report/getPosDetails/') ;?>" + id,
          type: "GET",
          dataType:"JSON",
          success: function(data){
            ...
            $('[name="transactionID"]').val(data.transaction_id);
