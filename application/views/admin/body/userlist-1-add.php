...
<div class="container-fluid">
  ...
  <hr>
  <form class="row" action="<?php echo base_url('func_setting/adduser'); ?>" method="post" id="form" enctype="multipart/form-data">
                ...
                <div class="col-lg-12">
                  <div class="form-group input-group">
                    <div class="input-group-prepend">
                      ...
                      <input name="fname" id="money1" class="form-control" type="text">
                  </div> 
                  <div class="form-group input-group">
                    <div class="input-group-prepend">
                      <span class="input-group-text"> Last Name </span>
                   </div>
                      <input name="lname" id="money2" class="form-control" type="text">
                  </div>
                  <div class="form-group input-group">
                    <div class="input-group-prepend">
                  ...
                  <div class="form-group input-group">
                    <div class="input-group-prepend">
                      ...
                      <input name="company" id="money4" class="form-control" type="text">
                  </div>
                  <div class="form-group input-group">
                    <div class="input-group-prepend">
                      <span class="input-group-text"> Email </span>
                    </div>
                      <input name="email" id="money5" class="form-control" type="text">
                  </div>
                  <div class="form-group input-group">
                    <div class="input-group-prepend">
...
                    </select>
              ...
              <div class="col-lg-12">
                  <button class="btn btn-primary col-lg-12">Register New User</button>
              </div>                                       
          </div>                         
        </div>
      </div>
