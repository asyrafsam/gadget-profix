            ...
            <ul class="nav navbar-nav navbar-right">
              <li class="dropdown">
                ...
                <ul class="dropdown-menu" role="menu">
                  <li><a href="<?php echo base_url(). 'func_excel/excel_sales_reparation/'.$random; ?>">&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-fw fa-file-excel"></i> <span class="badge">EXCEL</a></li>
                  <li><a href="<?php echo base_url(). 'func_pdf/pdf_sales_reparation/'.$random; ?>">&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-fw fa-file-pdf"></i> <span class="badge">PDF</a></li>
                </ul>
              </li>
            </ul>
          </div>
          ...
          <div class="table-responsive">
            ...
            <table class="table table-striped table-bordered" id="dataTable" width="100%" cellspacing="0" style="font-size: 13px;color: #000;">
              ...
              <?php 
                $test = '1';
                foreach ($sales as $p) {
                  $totaltax = $p->r_subtotal + $p->r_tax;
                  $all = $totaltax - $p->r_paid;
                  $balance = $p->r_total - $p->payTotal;
              ?>
                <tr style="background-color: #e3e6f0;">
                    ...
                    <input type="checkbox" class="chkbox" name="checksales" id="checksales" onclick="getDetailSales(<?php echo $p->hold_id; ?>)" value="<?php echo $p->hold_id?>">
                    </td>
                    <td><?php echo $p->r_repairno ?></td>
                    <td><?php echo $p->r_opened?></td>
                    <td><?php echo $p->c_name?></td>
                    <td><?php echo $p->product_name?></td>
                    <td><?php echo $totaltax?>.00</td>
                    <td><?php echo $p->r_tax ?></td>
                    <td><?php echo $p->r_paid?></td>
                    <td><?php echo $all?>.00</td>
                    <?php if($p->r_total <= $p->payTotal){?>
                    ...
                    <td>
                      <div class="dropdown no-arrow">
                         ...
                         <div class="dropdown-menu dropdown-menu-left shadow animated--fade-in" aria-labelledby="dropdownMenuLink">
                           ...
                           <a class="dropdown-item" href="#" onclick="view_reparation('<?php echo $p->r_code?>')"><i class="fa fa-fw fa-eye"> &nbsp;Sale Details</i></a>
                           <!-- <a class="dropdown-item" href="<?php echo base_url(). 'admin/print_view_sales/'.$p->r_code; ?>"><i class="fa fa-fw fa-print"> &nbsp;&nbsp;View Sale</i></a> -->
                           <a class="dropdown-item" href="<?php echo base_url(). 'func_report/sendMailSalesReparation/'.$p->hold_id; ?>"><i class="fa fa-fw fa-cloud"> &nbsp;Email Invoice</i></a>
                           <a class="dropdown-item" href="#" onclick="view_payment('<?php echo $p->r_code?>')"><i class="fa fa-fw fa-money-bill-alt"> &nbsp;View Payments</i></a>
                           <a class="dropdown-item" href="#" onclick="add_payment('<?php echo $p->r_code?>')"><i class="fa fa-fw fa-money-bill-alt"> &nbsp;Add Payments</i></a>
                         </div>
                      </div>
                    </td>
                </tr>
...
<script type="text/javascript">
  ...
  function daterange(start,end){
    ...
    $.ajax({
                    url: '<?= base_url() ?>func_report/viewsalesreparationselected',
                    type: 'POST',
                    dataType: 'html',
                    data: data,
                    beforeSend: function() {
